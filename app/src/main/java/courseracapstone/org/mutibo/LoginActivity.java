...
//            mAuthTask.execute((Void) null);
            ...
            final MutiboSvcApi svc = MutiboScv.init(server, email, password);
            ...
            CallableTask.invoke(new Callable<List<MutiboUser>>() {
                ...
                public List<MutiboUser> call() throws Exception {
                    ...
                    MutiboUser userInput = new MutiboUser(email,password);
                    MutiboUser userResponse = svc.getUserDetails(userInput);

                    List<MutiboUser> result = new ArrayList<MutiboUser>();
                ...
                @Override
                public void success(List<MutiboUser> result) {
